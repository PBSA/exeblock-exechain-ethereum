...
const std::map<std::string,  Instruction> dev::eth::c_instructions =
{
	...
	{ "IDASSET", Instruction::IDASSET }, // TODO temp
	{ "PROPERTY", Instruction::PROPERTY }, // TODO temp
	{ "CONVERT", Instruction::CONVERT } // TODO temp
};
...
{ //                                               Add,  Args,  Ret,  SideEffects, GasPriceTier
	...
	{ Instruction::IDASSET,      { "IDASSET",        0,     0,    1,  false,       Tier::Base } }, // TODO temp
	{ Instruction::PROPERTY,     { "PROPERTY",       0,     2,    1,  false,       Tier::Special } }, // TODO temp
	{ Instruction::CONVERT,      { "CONVERT",        0,     2,    1,  false,       Tier::Special } }, // TODO temp
}; 
